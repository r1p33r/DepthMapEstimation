...
# Note:
**To estimate depth maps using CycleGAN, it is important to use the reconstructed images in the prediction stage, and not the fake images generated by the network**.
**The options can be observed in /models/cycle_gan_model.py**.
